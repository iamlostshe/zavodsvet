    ...
    (function () {
      function Se(a, c, b, d) {
        ...
        return C(window, "c.i", function () {
          ...
          var y = Wc.o("counters", {});
          if (y[r])
            return pb(k, r, "Duplicate counter " + r + " initialization"), y[r];
          y[r] = e;
          Wc.C("counters", y);
          Wc.Ra("counter", e);
          z(function (G) {
        ...
        if (c.Wj || !e) d();
          ...
          if (3 === c.id) e();
            ...
            if (k) k(e);
              ...
              ((k = (k = lh(f)) ? A(v(Wd, n), k.split(",")) : []), mh(k))
            )
              e();
            else {
              var l = Xd(a),
                  ...
                  (0, Ze[0])(a)
                    ...
                    .then(function (r) {
                      if (r || q) {
                        ...
                        if (y)
                          return (
                            (r = Ol(a, t, y, c, p)), r.then(F([a, c], Pl)), r
                          );
                      }
                      r || t("8");
                      return K.resolve({
          ...
          if ("0" === n(e, "settings.pcs") && !Zc(a))
            if (((e = d.o("zzlc")), V(e) || Ta(e) || "na" === e)) {
              ...
              if ((f = $a(a))) {
                ...
                h.src =
                  "https://mc.yandex." + e + rh("L21ldHJpa2EvenpsYy5odG1s");
                if ((e = Vb(a))) {
                  e.appendChild(h);
                  var k = 0,
                    l = ia(a).D(
      ...
      function lf(a, c, b) {
        if ((c = Ha(a, c)))
          (a = Ec(["dr", b || "" + Ua(a, 10, 99)])), c.params(Ec(["__ym", a]));
      }
      function kf(a, c) {
        var b = null;
        try {
        ...
        d.D(["sr"], function (t) {
          ...
          y &&
            rf(
              a,
              t.source,
              ((r = {}), (r.type = "\u043d"), (r.frameId = c.ta().Z(y)), r),
            );
        });
        d.D(["sd"], function (t) {
          var r = t.data;
      ...
      function de(a, c, b, d, e, f) {
        ...
        if (sf(c))
          "value" === b
            ...
            : "checked" === b &&
                H((c.getAttribute("type") || "").toLowerCase(), Um)
      ...
      function Uo(a, c) {
        ...
        l = [
          ...
          h.D(
            f,
            ["load"],
            F([ja, [D(t.removeChild, t, f), D(l.appendChild, l, q)]], z),
          ),
        ...
        l.push(
          h.D(a, ["securitypolicyviolation"], function (X) {
            (X = n(X, "blockedURI")) &&
              0 <= X.indexOf("https://metrika.yandex.ru") &&
              O();
          }),
        );
        m.appendChild(k);
      ...
      function Db(a, c, b, d) {
        return Vf(c)
          ? B
          : v(F(wa([a, N(c)], d ? [b + ". Params:", d] : [b]), pb), ja);
      }
      function pb() {
        var a = Aa(arguments),
          c = a.slice(2);
                ...
                (h =
                  "p" === g
                    ...
                    : "c" === g
                      ...
                      : Nc[g](a, c));
            h &&
              ((h = h.slice(0, oj[g] || 100)), (f[g] = ig[g] ? "" + kc(h) : h));
            return f;
          },
          {},
          b,
      ...
      function Qj(a) {
        return (
          De(a) || od(a) || /mobile/i.test(sb(a)) || !V(n(a, "orientation"))
        );
      }
      function df(a, c) {
        if (Hd(a) && c) {
      ...
      function kd(a, c, b) {
        a =
          c &&
          (lc(c.className, "ym-disable-keys") ||
            lc(c.className, "-metrika-nokeys"));
        return b && c
      ...
      var za = E(
          ...
          function d(G) {
            return function (O) {
              ...
              if (G || (!t && !k.Ud)) {
                ...
                if (sa)
                  return (sa = g(xa, c)), Ic(a, "l.o.l", sa, O.callback, O.ctx);
              }
              return null;
            };
          }
        ...
        ss = E("s.f.i", function (a, c) {
          ...
          ia(a).D(
            a,
            ["submit"],
            C(a, "s.f.e", u(U("target"), F([a, c, b], rs))),
          );
          ...
          return pa(a, c, function (b) {
            if (
              ...
              ia(a).D(
                a,
                ["click"],
                C(a, "c.t.c", u(U("target"), F([a, c], Te(a, c, "", fp)))),
              ),
        ...
        Vk = (function (a) {
          ...
          c.prototype.La = function (b) {
            ...
            b ||
              ((b = e = d.parentNode),
              !$b("head", this.l, d) && e && 0 !== Pb(e).length) ||
        ...
        Dt = (function (a) {
          ...
          c.prototype.oi = function (b) {
            if (this.Lc(b)) {
              ...
              1 === this.Fa.length &&
                ((b = this.Fa[0]),
                H(b.keyCode, zt) && (this.ad([b], !0), this.reset()));
          ...
          return new K(function (b, d) {
            if (aq(a, gl, "isp")) {
              var e = function (f) {
                ...
                f = qj(gl);
                H("isp", f.ub) &&
                  ((f.ub = Z(u(ma("isp"), Rb), f.ub)),
                  f.ub.length || (jc(f.lb), (f.lb = null)));
              };
      ...
      var Tt = E("p.e", function (a, c) {
        ...
        vm = E("ep.dec", function (a, c) {
          ...
          for (var h = 0; d.length < e && f[h]; )
            (g += f[h]),
              b[g] && ((d += String.fromCharCode(Kg(b[g]))), (g = "")),
              (h += 1);
          b = "";
          for (f = 0; f < d.length; )
            (e = d.charCodeAt(f)),
        ...
        fh = w(
          function (a, c) {
            ...
            g ||
              d.Ud ||
              Nd(a) ||
              (e.push(F([am, "zzlc", "na"], f)), e.push(F([$l, "cc", ""], f)));
            return e.length
              ? {
                  Ba: function (h, k) {
                    if (0 === b.o("isEU"))
      ...
      Td.push(function (a, c) {
        ...
        if (!b.ce.Ud) {
          ...
          if (e && 30 > d - e)
            (b = b.ea), delete I(a).o("counters", {})[b], db(Sa("uws"));
